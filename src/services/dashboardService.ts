...
export const dashboardService = {
     ...
     */
    async getStats(companyId: string, role: string, userId: string) {
        if (role === 'driver') {
            return this.getDriverStats(userId);
        }
     ...
     */
    async getActivities(companyId: string, role: string, userId: string) {
